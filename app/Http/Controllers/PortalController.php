...
class PortalController extends Controller
{
    ...
    public function general_portal()
    {
        ...
        return view('portals/general_portal', compact('companies', 'featured_openings', 'openings','provinces','countries'));
    ...
    public function portal_ph_division_search($code){
        ...
        $provinces = \DB::table('provinces')->where('division',$code)->lists('iso_code');
