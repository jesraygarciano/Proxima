...
class UserController extends Controller
{
    ...
    public function json_get_opening_notification(Request $requests){
        ...
        $bookmarks = \DB::table('save_openings')->whereIn('opening_id',$notifications->lists('opening_id'))->get();
    	$openings = Opening::whereIn('id',$notifications->lists('opening_id'))->orderBy('created_at','desc')->get();
